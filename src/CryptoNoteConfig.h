...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x43; //starts with "w"
...
const char     CRYPTONOTE_NAME[]                             = "wildecoin";
...
const int      P2P_DEFAULT_PORT                              = 48010;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 48011;
